    ...
    function getWeather() {
        ...
        $.ajax({
            ...
            .then(function (data) {
                ...
                var iconImg = "<img src='https://openweathermap.org/img/wn/" + icon + "@2x.png'/>";
                ...
                var uvIndexURL = "https://api.openweathermap.org/data/2.5/uvi?appid=2773778a96cd8ad6907c9b5308565aa1&lat=" + lat + "&lon=" + long;
                ...
                var geoURL = "https://api.openweathermap.org/data/2.5/forecast?appid=2773778a96cd8ad6907c9b5308565aa1&units=imperial&lat=" + lat + "&lon=" + long;
                ...
                $.ajax({
                    ...
                    var firstImg = "https://openweathermap.org/img/wn/" + firstIcon + ".png";
                    ...
                    var secondImg = "https://openweathermap.org/img/wn/" + secondIcon + ".png";
                    ...
                    var thirdImg = "https://openweathermap.org/img/wn/" + thirdIcon + ".png";
                    ...
                    var fourthImg = "https://openweathermap.org/img/wn/" + fourthIcon + ".png";
                    ...
                    var fifthImg = "https://openweathermap.org/img/wn/" + fifthIcon + ".png";
